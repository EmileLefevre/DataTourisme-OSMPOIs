          ...
          <View style={styles.section}>
            ...
            {isTour && (
              <View style={styles.tourInfo}>
                {poi.duration && (
                  <Text style={styles.tourItem}>⏱️ Durée : {poi.duration}</Text>
                )}
                {poi.distance && (
                  <Text style={styles.tourItem}>📏 Distance : {poi.distance}</Text>
                )}
                {poi.tourType && (
                  <Text style={styles.tourItem}>🔄 Type : {poi.tourType}</Text>
                )}
              </View>
            )}
            ...
            {poi.paymentMethods && poi.paymentMethods.length > 0 && (
              <View style={styles.paymentSection}>
                ...
                <View style={styles.badgesContainer}>
                  {poi.paymentMethods.map((method, index) => (
